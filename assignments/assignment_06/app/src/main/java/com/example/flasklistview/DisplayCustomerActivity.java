...
public class DisplayCustomerActivity extends AppCompatActivity {
    protected static final String url = "http://IP.IP.IP.IP:5000/update";
    //url needs to change
    ...
    protected void populateView(Customer customer)
    {
        ...
        ArrayAdapter<String> array = new ArrayAdapter<>(this, R.layout.comment_item, customer.getComments());
        l.setAdapter(array);
    }
}
